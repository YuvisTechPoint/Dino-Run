...
class PixelDustComponent extends PositionComponent {
  ...
  }) : super(position: position, size: const Vector2(4, 4));
...
class AuroraComponent extends PositionComponent {
  ...
  void render(Canvas canvas) {
    ...
    final paint = Paint()..color = colors[auroraColor].withOpacity(0.8);
    canvas.drawRect(Rect.fromLTWH(0, 0, size.x, size.y), paint);
  }
  ...
  void update(double dt) {
    super.update(dt);
    _time += dt;
    position.y += waveSpeed * dt;
    position.x += waveAmplitude * dt * 0.5;
  }
}
...
class CandySparkleComponent extends PositionComponent {
  ...
  }) : super(position: position, size: const Vector2(3, 3));
  ...
  void render(Canvas canvas) {
    ...
    final paint = Paint()..color = colors[sparkleColor].withOpacity(0.8);
    canvas.drawRect(Rect.fromLTWH(0, 0, size.x, size.y), paint);
  }
...
class RaindropComponent extends PositionComponent {
  ...
  RaindropComponent({
    required Vector2 position,
    required this.fallSpeed,
  }) : super(position: position, size: const Vector2(2, 8));
...
class AshParticleComponent extends PositionComponent {
  ...
  AshParticleComponent({
    ...
    required this.fallSpeed,
    required this.swayAmount,
  }) : super(position: position, size: const Vector2(5, 5));
...
class CandyRainComponent extends PositionComponent {
  ...
  CandyRainComponent({
    ...
    required this.fallSpeed,
    required this.color,
  }) : super(position: position, size: Vector2(6, 6));
...
class LeafComponent extends PositionComponent {
  ...
  }) : super(position: position, size: Vector2(4, 6));
...
class RetroFilterComponent extends PositionComponent {
  final Vector2 screenSize;
  
  RetroFilterComponent({required this.screenSize}) : super(size: screenSize);
...
class HeatShimmerComponent extends PositionComponent {
  final Vector2 screenSize;
  
  HeatShimmerComponent({required this.screenSize}) : super(size: screenSize);
...
class NeonGlowComponent extends PositionComponent {
  final Vector2 screenSize;
  
  NeonGlowComponent({required this.screenSize}) : super(size: screenSize);
...
class ZeroGravityComponent extends PositionComponent {
  @override
  void update(double dt) {
    super.update(dt);
...
class RainbowTrailComponent extends PositionComponent {
  @override
  void render(Canvas canvas) {
...
class IceReflectionComponent extends PositionComponent {
  final Vector2 screenSize;
  
  IceReflectionComponent({required this.screenSize}) : super(size: screenSize);
...
class AncientGlowComponent extends PositionComponent {
  final Vector2 screenSize;
  AncientGlowComponent({required this.screenSize}) : super(size: screenSize);
...
class LavaGlowComponent extends PositionComponent {
  final Vector2 screenSize;
  
  LavaGlowComponent({required this.screenSize}) : super(size: screenSize);
...
class PixelDustComponent extends PositionComponent {
  ...
  }) : super(position: position, size: Vector2(2, 2));
...
class MeteorComponent extends PositionComponent {
  ...
  }) : super(position: position, size: Vector2(12, 20));
...
class TrafficLightComponent extends PositionComponent {
  ...
  }) : super(position: position, size: Vector2(6, 12));
...
class AuroraComponent extends PositionComponent {
  ...
  AuroraComponent({
    ...
    required this.waveSpeed,
    required this.auroraColor,
  }) : super(position: position, size: Vector2(200, 100));
...
class VineComponent extends PositionComponent {
  ...
  }) : super(position: position, size: Vector2(10, length));
